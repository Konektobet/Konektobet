...
@Component({
  selector: 'app-make-matched-appointment',
  templateUrl: './make-matched-appointment.component.html',
  styleUrls: ['./make-matched-appointment.component.scss']
})
export class MakeMatchedAppointmentComponent {
  clinic: any;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<MakeMatchedAppointmentComponent>,
